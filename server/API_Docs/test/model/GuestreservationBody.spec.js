...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GuestreservationBody', function() {
      beforeEach(function() {
        instance = new DropBearTable.GuestreservationBody();
      });

      it('should create an instance of GuestreservationBody', function() {
        // TODO: update the code to test GuestreservationBody
        expect(instance).to.be.a(DropBearTable.GuestreservationBody);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse401Errors', function() {
      beforeEach(function() {
        instance = new DropBearTable.InlineResponse401Errors();
      });

      it('should create an instance of InlineResponse401Errors', function() {
        // TODO: update the code to test InlineResponse401Errors
        expect(instance).to.be.a(DropBearTable.InlineResponse401Errors);
      });
